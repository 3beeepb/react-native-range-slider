...
// containers
import FollowerContainer from '../containers/LabelContainer';
...
export const useLowHigh = (lowProp, highProp, min, max, step) => {
    ...
    const { ow:lowState,high:highState} = inPropsRef.current;
...
export const useThumbFollower = (containerWidthRef, gestureStateRef, renderContent, isPressed, allowOverflow) => {
    ...
    const handleLayout = useWidthLayout(widthRef, () => update(gestureStateRef.current.lastPosition,gestureStateRef.current.lastValue));
